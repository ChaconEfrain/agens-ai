  ...
  try {
    ...
    return await db
      ...
      .values({
        ...
        commonQuestions:
          businessInfo.customerService.commonQuestions?.map((q) => ({
            question: q.question || "",
            answer: q.answer || "",
          })) ?? [],
        ...
        internationalShipping:
          businessInfo.shippingLogistics?.internationalShipping,
        items:
          businessInfo.productsServices.items?.map((item) => ({
            name: item.name || "",
        ...
        shippingRestrictions:
          businessInfo.shippingLogistics?.shippingRestrictions,
